...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Disable admin nav sidebar for a cleaner custom dashboard
                'accounts.context_processors.disable_admin_sidebar',
            ],
        },
    },
]
...
# Redirect to site home after logout (including admin logout)
LOGOUT_REDIRECT_URL = '/'
